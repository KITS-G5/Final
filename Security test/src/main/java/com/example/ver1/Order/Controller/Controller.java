...
public class Controller {
    ...
    @GetMapping(path = "/user/{cardNum}")
    List<Order> getAllOrderListByUserID(@PathVariable String cardNum){
        return orderService.getAllOrders().stream().filter(s -> s.getCard().getCardNum().equals(cardNum)).collect(Collectors.toList());
    }
